...
const MentorHeader = () => {
 ...
 // console.log(logindata)
  ...
  const logoutuser = async () => {
    ...
    const res = await fetch(`${API}/mentorlogout`, {
        method: "GET",
        headers: {
      ...
      <nav>
          {logindata.ValidMentorOne ? (
            <div className="studentbar">
              ...
              />
              <span onClick={()=>navigate("/mentordashboard")}>AllQueries</span>
              <span>MentorQueries</span>
            </div>
          ) : (
            <img
              className="zenimage"
          ...
          <div className="avtar ">
            {logindata.ValidMentorOne? (
              <span>{logindata.ValidMentorOne.fname}</span>
            ) : (
              ""
            )}
            {logindata.ValidMentorOne ? (
